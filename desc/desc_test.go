		...
		},
		{
			...
			Desc{Package: "roxygen2", Source: "", Version: "4.1.1.9000", Maintainer: "",
				...
				Imports: map[string]Dep{
					...
					"Rcpp":    Dep{Name: "Rcpp", Version: Version{Major: 0, Minor: 11, Patch: 0, Dev: 0, Other: 0}, Constraint: 1},
					"stringr": Dep{Name: "stringr", Version: Version{Major: 0, Minor: 5, Patch: 0, Dev: 0, Other: 0}, Constraint: 1},
				...
				Suggests: map[string]Dep{"knitr": Dep{Name: "knitr", Version: Version{Major: 0, Minor: 0, Patch: 0, Dev: 0, Other: 0}, Constraint: 0},
					"testthat": Dep{Name: "testthat", Version: Version{Major: 0, Minor: 8, Patch: 0, Dev: 0, Other: 0}, Constraint: 1},
				},
				Depends:   map[string]Dep{"R": Dep{Name: "R", Version: Version{Major: 3, Minor: 0, Patch: 2, Dev: 0, Other: 0}, Constraint: 1}},
